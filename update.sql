...
update `#__jshopping_order_status` set `name_uk-UA` = 'В очікуванні', `name_ru-RU` = 'Ожидающий' where `status_id` = '1';
...
update `#__jshopping_payment_method` set `name_uk-UA` = 'PayPal', `description_uk-UA` = 'PayPal', `name_ru-RU` = 'PayPal', `description_ru-RU` = 'PayPal' where `payment_id` = '3';
